...
export class AddCandidatesComponent {
  ...
  constructor(
    ...
    this.fieldCount = this.config.data?.count;
  }
  ...
  highlightVisibleFields(fieldsName: any) {
    //  const field = fieldsName
    //    ? this.fieldsName.split(',').map((field: string) => field.trim())
    //     : [];
