...
@Component({
  ...
  standalone: false,
  templateUrl: './candidate-multiple-resume-form.component.html',
  styleUrl: './candidate-multiple-resume-form.component.css'
})
export class CandidateMultipleResumeFormComponent {
  step = 1;
