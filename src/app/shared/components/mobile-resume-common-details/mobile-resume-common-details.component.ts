...
@Component({
  ...
  standalone: false,
  templateUrl: './mobile-resume-common-details.component.html',
  styleUrl: './mobile-resume-common-details.component.css',
})
export class MobileResumeCommonDetailsComponent {
