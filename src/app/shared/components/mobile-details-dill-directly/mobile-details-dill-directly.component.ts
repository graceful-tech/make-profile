...
@Component({
  ...
  standalone: false,
  templateUrl: './mobile-details-dill-directly.component.html',
  styleUrl: './mobile-details-dill-directly.component.css',
})
export class MobileDetailsDillDirectlyComponent {
  candidateId: any;
  multipartFile: any;
  resume: any;
  candidates: any;
  ...
  openPopupMessage(name: any) {
    this.dialog.open(MobileLoginReminderPopupComponent, {
      data: {
        name: name,
      },
      header: '',
