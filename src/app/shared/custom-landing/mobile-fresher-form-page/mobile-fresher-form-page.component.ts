...
@Component({
  ...
  standalone: false,
  templateUrl: './mobile-fresher-form-page.component.html',
  styleUrl: './mobile-fresher-form-page.component.css',
})
export class MobileFresherFormPageComponent {
  ...
  openPopupMessage(name: any) {
    this.dialogeService.open(MobileLoginReminderPopupComponent, {
      data: {
        name: name,
      },
      header: '',
